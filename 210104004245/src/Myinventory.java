...
class Inventory {
 ...
 inventory.addDevice(new ElectronicDevice("TV", "Samsung 4K TV", 890.00, 5));
 inventory.addDevice(new ElectronicDevice("Smartphone", "iPhone 15", 2500.99, 10));
 inventory.addDevice(new ElectronicDevice("Laptop", "MSI ", 2000.00, 3));
 inventory.addDevice(new ElectronicDevice("Tablet", "iPad Air", 599.99, 7));
 inventory.addDevice(new ElectronicDevice("Headphones", "Sony ", 350.00, 15));
